...
public:
	...
	// ----------ZMJ----------
	static FString GetUSMBlueprintIdStr(USMBlueprint* Blueprint)
	{
		auto Name = Blueprint->GetName();
	...
	static FString GetUSMBlueprintExportJsonPath(USMBlueprint* Blueprint)
	{
		auto IdStr = GetUSMBlueprintIdStr(Blueprint);
		return FPaths::ProjectDir() + FSMBlueprintEditorUtils::GetEditorSettings()->ExportJsonPath + IdStr;
	}
	// ----------ZMJ----------
};
