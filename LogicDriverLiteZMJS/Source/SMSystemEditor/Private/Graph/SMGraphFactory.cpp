...
#include "Nodes/SlateNodes/SGraphNodeZ_BaseBlockNode.h"
#include "Nodes/SMGraphK2Node_StateMachineNode.h"
#include "Nodes/SMGraphNodeZ_BaseBlock.h"
#include "Nodes/SMGraphNodeZ_EnterBlock.h"
#include "Nodes/SMGraphNodeZ_TextBlock.h"
...
#include "Nodes/SlateNodes/SGraphNodeZ_TextBlockNode.h"
...
{
	// ----------ZMJ----------
	/*if (USMGraphNodeZ_TextBlock* BlockNode = Cast<USMGraphNodeZ_TextBlock>(Node))
	{
		return SNew(SGraphNodeZ_TextBlockNode, BlockNode);
	}*/
	if (USMGraphNodeZ_BaseBlock* BlockNode = Cast<USMGraphNodeZ_BaseBlock>(Node))
	{
		return SNew(SGraphNodeZ_BaseBlockNode, BlockNode);
	}
	// ----------ZMJ----------
