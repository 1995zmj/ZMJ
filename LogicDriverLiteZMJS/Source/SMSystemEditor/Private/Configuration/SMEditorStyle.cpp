...
void FSMEditorStyle::SetIcons()
{
	...
	// ----------ZMJ----------
	// Graph Block Icons
	StyleSetInstance->Set("SMGraph.BaseBlock", new IMAGE_BRUSH(TEXT("Icons/BaseBlockIcon_16"), Icon16x16));
	StyleSetInstance->Set("SMGraph.TextBlock", new IMAGE_BRUSH(TEXT("Icons/TextBlockIcon"), Icon16x16));
	StyleSetInstance->Set("SMGraph.OptionBlock", new IMAGE_BRUSH(TEXT("Icons/OptionBlockIcon"), Icon16x16));
	// ----------ZMJ----------
}
