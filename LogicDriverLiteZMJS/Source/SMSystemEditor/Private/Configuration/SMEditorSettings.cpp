...
USMEditorSettings::USMEditorSettings()
{
	...
	BlocksDefaultColor = FLinearColor(0.7f, 0.7f, 0.7f, 1.f);
	ExportCSVPath = TEXT("../../../protocol/csv/StrangeEventsEditor/");
	ExportJsonPath = TEXT("Content/Configs/StrangeEventsEditor/");
	// ----------ZMJ----------
}
