...
void FSMEditorCommands::RegisterCommands()
{
	...
	// ZMJ
	UI_COMMAND(AddOption, "Add Option", "Add Option", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(RemoveOption, "Remove Option", "Remove Option", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(ExportFile, "Export File", "Export File", EUserInterfaceActionType::Button, FInputChord());
}
