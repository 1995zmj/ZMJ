...
![tupian](https://latex.codecogs.com/gif.latex?\\vec{v}+\vec{w})

示例：

![tupian](https://latex.codecogs.com/gif.latex?\\begin{bmatrix}3\\\\-5\end{bmatrix}+\begin{bmatrix}2\\\\1\end{bmatrix}=\begin{bmatrix}3+2\\\\-5+1\end{bmatrix})
